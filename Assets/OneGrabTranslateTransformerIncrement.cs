...
public class OneGrabTranslateTransformerIncrement : MonoBehaviour, ITransformer
{
    ...
    public void UpdateTransform()
    {
        ...
        {
            constrainedPosition.x = Mathf.Round(constrainedPosition.x / incrementAmount) * incrementAmount;
            constrainedPosition.y = Mathf.Round(constrainedPosition.y / incrementAmount) * incrementAmount;
            constrainedPosition.z = Mathf.Round(constrainedPosition.z / incrementAmount) * incrementAmount;
        }
